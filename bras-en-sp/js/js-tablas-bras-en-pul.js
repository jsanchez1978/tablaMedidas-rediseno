 $(document).ready(function () {
     ...
     control2.change(function () {
         ...
         if (valorBusto != "0") {
             ...
             $('#NoRespuesta').fadeOut();
             if (valorBusto === "32B") {
                 $('#detalleRespuesta-complex').html("If your size is unavailable, you can try our bralettes and/or sports bras in Size S." + '<a href="/collections/bralette"> <u>Check them out!</u></a>');
             }
             if (valorBusto === "34B") {
                 $('#detalleRespuesta-complex').html("If your size is unavailable, you can try our bralettes and/or sports bras in Size M." + '<a href="/collections/bralette"> <u>Check them out!</u></a>');
             }
             if (valorBusto === "32C") {
                 $('#detalleRespuesta-complex').html("If your size is unavailable, you can try our bralettes and/or sports bras in Size M." + '<a href="/collections/bralette"> <u>Check them out!</u></a>');
             }
             ...
             if (valorBusto === "34D") {
                 $('#detalleRespuesta-complex').html("If your size is unavailable, you can try our bralettes and/or sports bras in Size L." + '<a href="/collections/bralette"> <u>Check them out!</u></a>');
             }
             if (valorBusto === "36D") {
                 $('#detalleRespuesta-complex').hhtml("If your size is unavailable, you can try our bralettes and/or sports bras in Size L." + '<a href="/collections/bralette"> <u>Check them out!</u></a>');
             }
             if (valorBusto === "36B") {
                 $('#detalleRespuesta-complex').hhtml("If your size is unavailable, you can try our bralettes and/or sports bras in Size M." + '<a href="/collections/bralette"> <u>Check them out!</u></a>');
             }
             if (valorBusto === "36C") {
                 $('#detalleRespuesta-complex').html("If your size is unavailable, you can try our bralettes and/or sports bras in Size L." + '<a href="/collections/bralette"> <u>Check them out!</u></a>');
             }
